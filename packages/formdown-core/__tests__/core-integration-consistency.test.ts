...
`
  ...
  describe('Core Functions Integration', () => {
    ...
    test('generateFormHTML should create hidden forms with field associations', () => {
      ...
      expect(html).toContain('<button type="submit" id="submit" form="formdown-form-1" part="button submit-button">Submit Form</button>')
    })
...
`
      ...
      expect(html).toContain('<button type="submit" id="submit1" form="form1" part="button submit-button">Submit 1</button>')
      expect(html).toContain('<button type="submit" id="submit2" form="form2" part="button submit-button">Submit 2</button>')
    })
